...
INSERT INTO nbgb_ifbl.sources (name) VALUES ('IFBL digit2009'), ('IFBL digit2010'), ('INBO Florabank');
...
--tentative to detect duplicates... seems wrong (some reported duplicated are in fact differents on other fields, such as observers)
...
group by scientificName, verbatimCoordinates, eventDate HAVING count(*) > 1;